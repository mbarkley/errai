 ...
 */
public class SingleResolution implements Resolution {

  private final Injectable injectable;

  public SingleResolution(final Injectable injectable) {
  ...
  public Stream<Injectable> stream() {
    return Stream.of(injectable);
  }

  @Override
  public String toString() {
    return "SingleResolution [" + injectable + "]";
  }
