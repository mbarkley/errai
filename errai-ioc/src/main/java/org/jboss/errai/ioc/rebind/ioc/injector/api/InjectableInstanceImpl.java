...
public class InjectableInstanceImpl<T extends Annotation> extends InjectionPoint<T> implements InjectableInstance<T> {
  ...
  public InjectableInstanceImpl(final T annotation,
  ...
  public static <T extends Annotation> InjectableInstance<T> getInjectedInstance(final T annotation,
    ...
    return new InjectableInstanceImpl<T>(annotation, TaskType.Type, null, null, null, type,
  ...
  public static <T extends Annotation> InjectableInstance<T> getMethodInjectedInstance(final MetaMethod method,
    ...
    return new InjectableInstanceImpl(
