...
public final class TemplateUtil {
  ...
  public static void setupBrowserEventListener(final Object component, final ElementWrapperWidget<?> element,
          final org.jboss.errai.common.client.dom.EventListener<?> listener, final String browserEventType) {
    setupBrowserEventListener(component, element.getElement(), listener, browserEventType);
  }
