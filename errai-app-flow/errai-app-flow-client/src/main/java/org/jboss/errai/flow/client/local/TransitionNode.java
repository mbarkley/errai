...
final class TransitionNode<INPUT, PREV_INPUT, OUTPUT> extends FlowNode<INPUT, OUTPUT> {

    Function<INPUT, AppFlow<PREV_INPUT, OUTPUT>> transition;

    TransitionNode( final Function<INPUT, AppFlow<PREV_INPUT, OUTPUT>> transition ) {
